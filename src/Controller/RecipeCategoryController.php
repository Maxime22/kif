...
{
    #[Route('/recipes/categories', name: 'app_recipe_category')]
    ...
    #[Route('/recipes/categories/new', name: 'app_recipe_category_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/recipes/categories/{id}/edit', name: 'app_recipe_category_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/recipes/categories/{id}/delete', name: 'app_recipe_category_delete', methods: ['DELETE'])]
